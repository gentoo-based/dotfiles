...
I used to host a DNS server for unbound here so yeah.
...
- An initializer for any Linux systems that support it made by [Davmac](https://github.com/davmac314/). Here is the portage overlay that I use: https://github.com/WavyEBuilder/dinit-overlay.

2. **[ungoogled-chromium](https://github.com/ungoogled-software/ungoogled-chromium)**
- An ungoogled version of chromium as a replacement for Brave that I use.

3. **[Niri](https://github.com/YaLTeR/niri)**
- A scrollable-tiling window manager made by YaLTeR (His made some good stuff!)
